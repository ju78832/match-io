      ...
      <div className="container grid items-center gap-12 px-4 md:px-6 lg:grid-cols-2 lg:gap-12">
        <div className="space-y-4">
          <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl">
            Connect with <span className="block mt-2 lg:mt-4 pb-2"></span>thousands of <span className="block"></span>
            <span className="inline-block bg-gradient-to-r from-[#2D5BFF] to-[#73737300] border-l-[3px] border-l-[#0011ff] mt-2 lg:mt-4 pb-2">Investors</span> <span className=""> in seconds</span>
          </h1>
